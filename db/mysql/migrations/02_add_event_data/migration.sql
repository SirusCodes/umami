...
ALTER TABLE account
    RENAME INDEX username TO account_username_key;
ALTER TABLE session
    RENAME INDEX session_uuid TO session_session_uuid_key;
ALTER TABLE website
    RENAME INDEX share_id TO website_share_id_key;
ALTER TABLE website
    RENAME INDEX website_uuid TO website_website_uuid_key;