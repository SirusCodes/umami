...
-- CreateAdminUser
INSERT INTO account (username, password, is_admin, account_uuid)
values (
        'admin',
        '$2a$10$WUg4aRQ22vYwvJqMgyndq.x.jR2h.0/4B3Ahih6Dlas2fTvdR1eWG',
        true,
        '318620df-1399-4914-9503-0816423d5fd1'
    );